...
public class BroadcastSavings extends BroadcastReceiver {
    ...
    public void setAlarm(Context context)
    {
        ...
        Intent i = new Intent(context, BroadcastSavings.class);
    ...
    {
        Intent intent = new Intent(context, BroadcastSavings.class);
